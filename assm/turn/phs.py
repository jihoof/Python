...
class PhysicalMove(posmon.Move()):
...
class Tackle(PhysicalMove):
    ...
    def use(self, our_posmon:posmon.Posmon, ai_posmon:posmon.Posmon, is_player_move=True):

        if is_player_move == True:
            attack_ratio = posmon.get_attack_ratio(our_posmon.type, ai_posmon.type)
            ...
            attack_ratio = posmon.get_attack_ratio(ai_posmon.type, our_posmon.type)
